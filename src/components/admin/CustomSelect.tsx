  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        className={`w-full px-4 py-2 text-left bg-white border rounded-xl flex items-center justify-between transition-colors focus:outline-none focus:ring-1 focus:ring-gray-900 focus:border-gray-900 ${
